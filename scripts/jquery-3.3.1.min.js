...
!(function (e, t) {
  ...
  function m(e, t, n) {
    let i
    const o = (t = t || r).createElement('script')
  ...
  (w.fn = w.prototype =
    {
      ...
      map(e) {
        return this.pushStack(w.map(this, (t, n) => e.call(t, n, t)))
      },
      slice() {
  ...
  w.extend({
    ...
    isPlainObject(e) {
      ...
      return (
        !(!e || c.call(e) !== '[object Object]') &&
          (!(t = i(e)) ||
            (typeof (n = f.call(t, 'constructor') && t.constructor) === 'function' &&
              p.call(n) === d))
      )
    },
    isEmptyObject(e) {
    ...
    makeArray(e, t) {
      const n = t || []
      return (
        e != null && (C(Object(e)) ? w.merge(n, typeof e === 'string' ? [e] : e) : s.call(n, e)),
        n
      )
    },
    inArray(e, t, n) {
    ...
    map(e, t, n) {
      ...
      let o = 0
      const s = []
      if (C(e)) for (r = e.length; o < r; o++) (i = t(e[o], o, n)) != null && s.push(i)
  ...
  function C(e) {
    ...
    const n = x(e)
    return (
      !g(e) && !y(e) && (n === 'array' || t === 0 || (typeof t === 'number' && t > 0 && t - 1 in e))
    )
  }
  const E = (function (e) {
    let t
    ...
    const ie = me(e => !0 === e.disabled && ('form' in e || 'label' in e), {
      dir: 'parentNode',
      next: 'legend',
    })
    try {
    ...
    function oe(e, t, r, i) {
      ...
      let h
      let v
      let m = t && t.ownerDocument
      const T = t ? t.nodeType : 9
      if (((r = r || []), typeof e !== 'string' || !e || (T !== 1 && T !== 9 && T !== 11)))
        return r
    ...
    (p = oe.setDocument =
        function (e) {
          ...
          return a !== d && a.nodeType === 9 && a.documentElement
            ...
            (n.attributes = ue(e => ((e.className = 'i'), !e.getAttribute('className')))),
            (n.getElementsByTagName = ue(
              e => (e.appendChild(d.createComment('')), !e.getElementsByTagName('*').length),
            )),
            ...
            n.getById
              ...
              : ((r.filter.ID = function (e) {
                ...
                return function (e) {
                  const n =
                        typeof e.getAttributeNode !== 'undefined' && e.getAttributeNode('id')
                  return n && n.value === t
                }
              }),
              (r.find.ID = function (e, t) {
            ...
            (n.qsa = Q.test(d.querySelectorAll)) &&
                ...
                ue(e => {
                  ...
                  e.querySelectorAll(':enabled').length !== 2 && y.push(':enabled', ':disabled'),
                  (h.appendChild(e).disabled = !0),
                  e.querySelectorAll(':disabled').length !== 2 && y.push(':enabled', ':disabled'),
    ...
    (oe.attr = function (e, t) {
      ...
      let o = i && N.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !g) : void 0
      return void 0 !== o
        ? o
        : n.attributes || !g
          ? e.getAttribute(t)
                  ...
                  E(e, e =>
                    t.test(
                      (typeof e.className === 'string' && e.className) ||
                        (typeof e.getAttribute !== 'undefined' && e.getAttribute('class')) ||
                        '',
                    ),
                  ))
              )
    ...
    function Ce(e) {
      for (
        var t,
          ...
          p = [
            function (e, n, r) {
              const i = (!a && (r || n !== l)) || ((t = n).nodeType ? c(e, n, r) : f(e, n, r))
              return (t = null), i
            },
          ];
        u < o;
    ...
    function Ee(e, t) {
      ...
      const o = function (o, a, s, u, c) {
        ...
        const k = C.length
        for (c && (l = a === d || a || c); m !== k && (f = C[m]) != null; m++) {
          if (i && f) {
    ...
    return (
      ...
      p(),
      (n.sortDetached = ue(e => 1 & e.compareDocumentPosition(d.createElement('fieldset')))),
      ue(e => ((e.innerHTML = "<a href='#'></a>"), e.firstChild.getAttribute('href') === '#')) ||
  ...
  w.fn.extend({
    ...
    is(e) {
      return !!j(this, typeof e === 'string' && D.test(e) ? w(e) : e || [], !1).length
    },
  })
  let q
  const L = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  ...
  w.fn.extend({
    ...
    closest(e, t) {
      ...
      const i = this.length
      const o = []
      const a = typeof e !== 'string' && w(e)
      if (!D.test(e))
        for (; r < i; r++)
          for (n = this[r]; n && n !== t; n = n.parentNode)
            if (
              n.nodeType < 11 &&
              (a ? a.index(n) > -1 : n.nodeType === 1 && w.find.matchesSelector(n, e))
            ) {
              o.push(n)
              break
            }
  ...
  w.extend({
    ...
    when(e) {
      ...
      if (
        t <= 1 &&
        ($(e, a.done(s(n)).resolve, a.reject, !t), a.state() === 'pending' || g(i[n] && i[n].then))
      )
        return a.then()
  ...
  const z = function (e, t, n, r, i, o, a) {
    let s = 0
    const u = e.length
    let l = n == null
    if (x(n) === 'object') {
  ...
  function te(e) {
    return (
      e === 'true' ||
      (e !== 'false' && (e === 'null' ? null : e === `${+e}` ? +e : Z.test(e) ? JSON.parse(e) : e))
    )
  }
  function ne(e, t, n) {
    let r
  ...
  w.extend({
    ...
    dequeue(e, t) {
      ...
      i && (t === 'fx' && n.unshift('inprogress'), delete o.stop, i.call(e, a, o)),
      !r && o && o.empty.fire()
    },
    _queueHooks(e, t) {
  ...
  const ae = function (e, t) {
    return (
      ...
      (e.style.display === '' && w.contains(e.ownerDocument, e) && w.css(e, 'display') === 'none')
    )
  }
  ...
  function ue(e, t, n, r) {
    ...
    let c = (w.cssNumber[t] || (l !== 'px' && +u)) && ie.exec(w.css(e, t))
    if (c && c[3] !== l) {
      (u /= 2), (l = l || c[3]), (c = +u || 1)
      while (a--)
  ...
  function fe(e, t) {
    for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
      (r = e[o]).style &&
        ((n = r.style.display),
        t
          ? (n === 'none' && ((i[o] = J.get(r, 'display') || null), i[o] || (r.style.display = '')),
  ...
  (w.event = {
    ...
    dispatch(e) {
      ...
      const c = w.event.special[t.type] || {}
    ...
    special: {
      ...
      click: {
        trigger() {
          if (this.type === 'checkbox' && this.click && N(this, 'input')) return this.click(), !1
        },
        _default(e) {
          return N(e.target, 'a')
        },
  ...
  w.extend({
    ...
    clone(e, t, n) {
      ...
      const u = w.contains(e.ownerDocument, e)
      ...
      return z(
        ...
        function (e) {
          ...
          if (
            ...
            try {
              for (; n < r; n++)
                (t = this[n] || {}).nodeType === 1 && (w.cleanData(ye(t, !1)), (t.innerHTML = e))
              t = 0
            } catch (e) {}
          }
  ...
  const We = new RegExp(`^(${re})(?!px)[a-z%]+$`, 'i')
  const $e = function (t) {
    let n = t.ownerDocument.defaultView
    return (n && n.opener) || (n = e), n.getComputedStyle(t)
  }
  const Be = new RegExp(oe.join('|'), 'i')
  !(function () {
    function t() {
      if (c) {
        (l.style.cssText =
  ...
  function Ze(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      ...
      r
        ...
        n !== 'margin' && (u -= w.css(e, `border${oe[a]}Width`, !0, i)))
  ...
  function et(e, t, n) {
    ...
    return (
      ...
      (i === 'auto' || (!parseFloat(i) && w.css(e, 'display', !1, r) === 'inline')) &&
  ...
  w.extend({
    ...
    style(e, t, n, r) {
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        n != null &&
            n === n &&
            (o === 'number' && (n += (i && i[3]) || (w.cssNumber[s] ? '' : 'px')),
            h.clearCloneStyle || n !== '' || t.indexOf('background') !== 0 || (l[t] = 'inherit'),
      ...
      return `${
        parseFloat(Fe(e, 'marginLeft')) ||
          e.getBoundingClientRect().left -
            se(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)
      }px`
  })),
  ...
  (tt.prototype = {
    ...
    cur() {
      const e = tt.propHooks[this.prop]
      return e && e.get ? e.get(this) : tt.propHooks._default.get(this)
    },
    run(e) {
      let t
      const n = tt.propHooks[this.prop]
      return (
  ...
  function pt(e, t, n) {
    ...
    var l = s.promise({
      ...
      tweens: [],
      createTween(t, n) {
        const r = w.Tween(e, l.opts, t, n, l.opts.specialEasing[t] || l.opts.easing)
  ...
  w.each(w.expr.match.bool.source.match(/\w+/g), (e, t) => {
    ...
    ht[t] = function (e, t, r) {
      ...
      return r || ((o = ht[a]), (ht[a] = i), (i = n(e, t, r) != null ? a : null), (ht[a] = o)), i
    }
  })
  ...
  w.extend({
    prop(e, t, n) {
      ...
      if (o !== 3 && o !== 8 && o !== 2)
        return (
          (o === 1 && w.isXMLDoc(e)) || ((t = w.propFix[t] || t), (i = w.propHooks[t])),
          void 0 !== n
            ? i && 'set' in i && void 0 !== (r = i.set(e, n, t))
              ? r
              : (e[t] = n)
  ...
  w.fn.extend({
    ...
    hasClass(e) {
      ...
      let r = 0
      t = ` ${e} `
      while ((n = this[r++])) if (n.nodeType === 1 && ` ${vt(mt(n))} `.indexOf(t) > -1) return !0
      return !1
    },
  })
  const bt = /\r/g
            ...
            this.each(function (n) {
              ...
              this.nodeType === 1 &&
                ((i = r ? e.call(this, n, w(this).val()) : e) == null
                  ...
                  : typeof i === 'number'
                    ? (i += '')
                    : Array.isArray(i) && (i = w.map(i, e => (e == null ? '' : `${e}`))),
  ...
  w.extend(w.event, {
    trigger(t, n, i, o) {
      ...
      let x = f.call(t, 'namespace') ? t.namespace.split('.') : []
      if (
        ((s = h = u = i = i || r),
        i.nodeType !== 3 &&
          i.nodeType !== 8 &&
  ...
  function jt(e, t, n, r) {
    ...
    if (Array.isArray(t))
      w.each(t, (t, i) => {
        n || St.test(e)
          ? r(e, i)
          : jt(`${e}[${typeof i === 'object' && i != null ? t : ''}]`, i, n, r)
      })
      ...
      return this.map(function () {
        ...
        .map(function (e, t) {
          ...
          return n == null
            ? null
            : Array.isArray(n)
              ? w.map(n, e => ({ name: t.name, value: e.replace(Dt, '\r\n') }))
  ...
  function zt(e, t) {
    let n
    let r
    const i = w.ajaxSettings.flatOptions || {}
    ...
    ajax(t, n) {
      ...
      var E = {
        ...
        setRequestHeader(e, t) {
          return (
            c == null && ((e = T[e.toLowerCase()] = T[e.toLowerCase()] || e), (b[e] = t)), this
          )
        },
        overrideMimeType(e) {
      ...
      if (
        ...
        return E;
      (f = w.event && h.global) && w.active++ == 0 && w.event.trigger('ajaxStart'),
        ...
        send(i, o) {
          (t = w('<script>')
            ...
            .on(
              'load error',
              (n = function (e) {
                t.remove(), (n = null), e && o(e.type === 'error' ? 404 : 200, e.type)
              }),
            )),
  ...
  (h.createHTMLDocument = (function () {
    const e = r.implementation.createHTMLDocument('').body
  ...
  (w.fn.load = function (e, t, n) {
    ...
    return (
      ...
      g(t) ? ((n = t), (t = void 0)) : t && typeof t === 'object' && (i = 'POST'),
      a.length > 0 &&
          w
  ...
  w.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, (e, t) => {
    ...
    w.fn[e] = function (r) {
      return z(
        ...
        (e, r, i) => {
          let o
          if ((y(e) ? (o = e) : e.nodeType === 9 && (o = e.defaultView), void 0 === i))
            return o ? o[t] : e[r]
  ...
  typeof define === 'function' && define.amd && define('jquery', [], () => w)
  const Jt = e.jQuery
  const Kt = e.$
  return (
