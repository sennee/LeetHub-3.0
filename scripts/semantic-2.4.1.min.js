    ...
    function (e) {
      ...
      return (
        (s = {
          ...
          change: {
            setting(o, a, e, r) {
              (e = typeof e === 'string' ? (e === 'all' ? u.modules : [e]) : e || u.modules),
              (r = r === b || r),
              p.each(e, (e, t) => {
                let n
                const i = !s.moduleExists(t) || p.fn[t].settings.namespace || !1
                s.moduleExists(t) &&
                    (s.verbose('Changing default setting', o, a, t),
                    (p.fn[t].settings[o] = a),
                    r &&
                      i &&
                      (n = p(`:data(module-${i})`)).length > 0 &&
                      (s.verbose('Modifying existing settings', n), n[t]('setting', o, a)))
              })
            },
            settings(i, e, o) {
              (e = typeof e === 'string' ? [e] : e || u.modules),
              (o = o === b || o),
              p.each(e, (e, t) => {
                let n
                s.moduleExists(t) &&
          ...
          invoke(i, e, t) {
            ...
            return (
              ...
              typeof i === 'string' &&
                ...
                (o = i.length - 1),
                p.each(i, (e, t) => {
                  const n = e != o ? t + i[e + 1].charAt(0).toUpperCase() + i[e + 1].slice(1) : i
...
(function (F, e, O, D) {
        ...
        (h = {
          ...
          clear() {
            n.each(function () {
              ...
              const t = e.parent()
              const n = e.closest(l)
              const i = n.find(f.prompt)
              const o = e.data(u.defaultValue) || ''
              const a = t.is(f.uiCheckbox)
              const r = t.is(f.uiDropdown)
              n.hasClass(m.error) &&
          ...
          is: {
            ...
            shorthandFields(e) {
              const t = e[Object.keys(e)[0]]
              return h.is.shorthandRules(t)
            },
            shorthandRules(e) {
              return typeof e === 'string' || F.isArray(e)
            },
            empty(e) {
              return (
                !e ||
          ...
          event: {
            field: {
              keydown(e) {
                const t = F(this)
                const n = e.which
                const i = t.is(f.input)
                const o = t.is(f.checkbox)
                const a = t.closest(f.uiDropdown).length > 0
                const r = 13
              ...
              blur(e) {
                const t = F(this)
                const n = t.closest(l)
                const i = h.get.validation(t)
                n.hasClass(m.error)
                  ? (h.debug('Revalidating field', t, i), i && h.validate.field(i))
                  : d.on == 'blur' && i && h.validate.field(i)
              },
              change(e) {
                const t = F(this)
                const n = t.closest(l)
                const i = h.get.validation(t)
                i &&
                      (d.on == 'change' || (n.hasClass(m.error) && d.revalidate)) &&
          ...
          get: {
            ...
            changeEvent(e, t) {
              return e == 'checkbox' || e == 'radio' || e == 'hidden' || t.is('select')
                ? 'change'
                : h.get.inputEvent()
            },
            inputEvent() {
            ...
            prompt(e, t) {
              let n
              let i
              const o = h.get.ruleName(e)
              const a = h.get.ancillaryValue(e)
              const r = h.get.field(t.identifier)
              const s = r.val()
              let l = F.isFunction(e.prompt)
                ? e.prompt(s)
                : e.prompt || d.prompt[o] || d.text.unspecifiedRule
              const c = l.search('{value}') !== -1
              const u = l.search('{name}') !== -1
              return (
                c && (l = l.replace('{value}', r.val())),
                u &&
                      ((i =
                        (n = r.closest(f.group).find('label').eq(0)).length == 1
                          ? n.text()
            ...
            settings() {
              if (F.isPlainObject(x)) {
                ...
                e.length > 0 && x[e[0]].identifier !== D && x[e[0]].rules !== D
            ...
            field(e) {
              return (
                ...
                n.filter(`#${e}`).length > 0
                  ? n.filter(`#${e}`)
                  : n.filter(`[name="${e}"]`).length > 0
                    ? n.filter(`[name="${e}"]`)
                    : n.filter(`[name="${e}[]"]`).length > 0
                      ? n.filter(`[name="${e}[]"]`)
                      : n.filter(`[data-${u.validate}="${e}"]`).length > 0
            ...
            values(e) {
              const t = F.isArray(e) ? h.get.fields(e) : n
              const c = {}
              return (
                t.each((e, t) => {
                  const n = F(t)
                  let i = (n.prop('type'), n.prop('name'))
                  const o = n.val()
                  const a = n.is(f.checkbox)
                  const r = n.is(f.radio)
                  const s = i.indexOf('[]') !== -1
                  const l = !!a && n.is(':checked')
                  i &&
                        (s
                          ? ((i = i.replace('[]', '')),
                          c[i] || (c[i] = []),
          ...
          has: {
            field(e) {
              return (
                ...
                typeof (e = h.escape.string(e)) !== 'string' && h.error(s.identifier, e),
                n.filter(`#${e}`).length > 0 ||
                      n.filter(`[name="${e}"]`).length > 0 ||
                      n.filter(`[data-${u.validate}="${e}"]`).length > 0
              )
          ...
          add: {
            ...
            prompt(e, t) {
              const n = h.get.field(e).closest(l)
              let i = n.children(f.prompt)
              const o = i.length !== 0;
          ...
          remove: {
            ...
            prompt(e) {
              const t = h.get.field(e).closest(l)
              const n = t.children(f.prompt)
              t.removeClass(m.error),
              d.inline &&
                      n.is(':visible') &&
                      (h.verbose('Removing prompt for field', e),
                      d.transition && F.fn.transition !== D && r.transition('is supported')
                        ? n.transition(`${d.transition} out`, d.duration, () => {
                          n.remove()
                        })
                        : n.fadeOut(d.duration, () => {
                          n.remove()
                        }))
            },
          },
          set: {
            ...
            defaults() {
              n.each(function () {
                const e = F(this)
                const t = e.filter(f.checkbox).length > 0 ? e.is(':checked') : e.val()
            ...
            values(e) {
              F.isEmptyObject(e) ||
                    F.each(e, (e, t) => {
                      let n
                      const i = h.get.field(e)
                      let o = i.parent()
                      const a = F.isArray(t)
                      const r = o.is(f.uiCheckbox)
                      const s = o.is(f.uiDropdown)
                      const l = i.is(f.radio) && r
                      i.length > 0 &&
                        (a && r
                          ...
                          F.each(t, (e, t) => {
                            (n = i.filter(`[value="${t}"]`)),
                            (o = n.parent()),
                            n.length > 0 && o.checkbox('check')
                          }))
                          : l
                            ? (h.verbose('Selecting radio value', t, i),
                            i.filter(`[value="${t}"]`).parent(f.uiCheckbox).checkbox('check'))
                            : r
          ...
          validate: {
            ...
            field(n, e, t) {
              (t = t === D || t),
              typeof n === 'string' && (h.verbose('Validating field', n), (n = c[(e = n)]))
              const i = n.identifier || e
              const o = h.get.field(i)
              const a = !!n.depends && h.get.field(n.depends)
              let r = !0
              const s = []
              return (
                n.identifier ||
            ...
            rule(e, t) {
              const n = h.get.field(e.identifier)
              let i = (t.type, n.val())
              const o = h.get.ancillaryValue(t)
              const a = h.get.ruleName(t)
              const r = d.rules[a]
              if (F.isFunction(r))
                return (
                  (i = i === D || i === '' || i === null ? '' : F.trim(`${i}`)), r.call(n, i, o)
                )
              h.error(s.noRule, a)
            },
          },
  ...
  (F.fn.form.settings = {
    ...
    rules: {
      empty(e) {
        return !(e === D || e === '' || (F.isArray(e) && e.length === 0))
      },
      checked() {
        return F(this).filter(':checked').length > 0
      },
      email(e) {
      ...
      regExp(e, t) {
        ...
        let n
        const i = t.match(F.fn.form.settings.regExp.flags)
        return (
          i && ((t = i.length >= 2 ? i[1] : t), (n = i.length >= 3 ? i[2] : '')),
      ...
      integer(e, t) {
        ...
        let i
        let o
        const a = F.fn.form.settings.regExp.integer
        return (
          t &&
                ['', '..'].indexOf(t) === -1 &&
                (t.indexOf('..') == -1
      ...
      is(e, t) {
        return (
          ...
          (e = typeof e === 'string' ? e.toLowerCase() : e) == t
        )
      },
      isExactly(e, t) {
        return e == t
      ...
      contains(e, t) {
        return (
          ...
          e.search(new RegExp(t, 'i')) !== -1
        )
      },
      containsExactly(e, t) {
        return (
          (t = t.replace(F.fn.form.settings.regExp.escape, '\\$&')),
          e.search(new RegExp(t)) !== -1
        )
      },
      doesntContain(e, t) {
        return (
      ...
      match(e, t) {
        ...
        F(this)
        return (
          F(`[data-validate="${t}"]`).length > 0
            ? (n = F(`[data-validate="${t}"]`).val())
            : F(`#${t}`).length > 0
              ? (n = F(`#${t}`).val())
              : F(`[name="${t}"]`).length > 0
                ? (n = F(`[name="${t}"]`).val())
                : F(`[name="${t}[]"]`).length > 0 && (n = F(`[name="${t}[]"]`)),
      ...
      creditCard(n, e) {
        ...
        if (typeof n === 'string' && n.length !== 0) {
          if (
            ...
            s &&
                  (F.each(s, (e, t) => {
                    (i = o[t]) &&
                      (a = {
                        length: F.inArray(n.length, i.length) !== -1,
                        pattern: n.search(i.pattern) !== -1,
                      }).length &&
                      a.pattern &&
                      (r = !0)
                  }),
          ...
          if (
            (t = {
              number: F.inArray(n.length, o.unionPay.length) !== -1,
              pattern: n.search(o.unionPay.pattern) !== -1,
            }).number &&
                t.pattern
          )
            return !0
  ...
  (S.fn.accordion = function (a) {
    ...
    return (
      r.each(function () {
        ...
        const o = r.selector || ''
        const m = S(this)
        let g = m.find(f.title)
        let p = m.find(f.content)
        const l = this
        let h = m.data(i);
        (c = {
          initialize() {
          ...
          toggle(e) {
            ...
            const n = t.next(p)
            const i = n.hasClass(d.animating)
            const o = n.hasClass(d.active)
            const a = o && !i
            const r = !o && i
          ...
          closeOthers(e) {
            ...
            let n
            let i
            const o = e !== T ? g.eq(e) : S(this).closest(f.title)
            const a = o.parents(f.content).prev(f.title)
            const r = o.closest(f.accordion)
            const s = `${f.title}.${d.active}:visible`
            const l = `${f.content}.${d.active}:visible`;
            (i = u.closeNested
...
(function (T, A, R, P) {
  ...
  (T.fn.checkbox = function (v) {
    ...
    let C = []
    const w = v
    const S = typeof w === 'string'
    const k = [].slice.call(arguments, 1)
    return (
      e.each(function () {
        let e
        let s
        const i = T.extend(!0, {}, T.fn.checkbox.settings, v)
        const t = i.className
        const n = i.namespace
        const o = i.selector
        const l = i.error
        ...
        const r = `module-${n}`
        let c = T(this)
        let u = T(this).children(o.label)
        let d = T(this).children(o.input)
        let f = d[0]
        let m = !1
        let g = !1
        let p = c.data(r)
        ...
        (s = {
          ...
          is: {
            ...
            radio() {
              return d.hasClass(t.radio) || d.attr('type') == 'radio'
            },
            indeterminate() {
          ...
          can: {
            ...
            uncheck() {
              return typeof i.uncheckable === 'boolean' ? i.uncheckable : !s.is.radio()
            },
          },
          set: {
            initialLoad() {
          ...
          trigger: {
            change() {
              const e = R.createEvent('HTMLEvents')
              const t = d[0]
              t &&
  ...
  (S.fn.dimmer = function (p) {
    ...
    return (
      v.each(function () {
        ...
        const c = `module-${e}`
        const u = v.selector || ''
        const d = 'ontouchstart' in k.documentElement ? 'touchstart' : 'click'
        const f = S(this)
        const m = this
        let g = f.data(c);
        (s = {
          ...
          event: {
            click(e) {
              ...
              (a.find(e.target).length === 0 || S(e.target).is(n.content)) &&
          ...
          animate: {
            show(e) {
              ...
              r.useCSS && S.fn.transition !== T && a.transition('is supported')
                ...
                s.set.dimmed(),
                r.opacity == 'auto' && (r.opacity = 0.8),
                a
                  .stop()
                  .css({ opacity: 0, width: '100%', height: '100%' })
                  .fadeTo(s.get.duration(), r.opacity, () => {
          ...
          get: {
            ...
            duration() {
              return typeof r.duration === 'object'
                ? s.is.active()
                  ? r.duration.hide
                  : r.duration.show
                : r.duration
          ...
          has: {
            dimmer() {
              return r.dimmerName
                ? f.find(n.dimmer).filter(`.${r.dimmerName}`).length > 0
                : f.find(n.dimmer).length > 0
            },
          },
          is: {
            active() {
            ...
            closable() {
              return r.closable == 'auto' ? r.on != 'hover' : r.closable
            },
            dimmer() {
          ...
          set: {
            opacity(e) {
              ...
              const n = t.split(',')
              const i = n && n.length == 3
              const o = n && n.length == 4;
              (e = r.opacity === 0 ? 0 : r.opacity || e),
...
(function (Y, Z, K, J) {
  ...
  (Y.fn.dropdown = function (M) {
    ...
    const N = Y(K)
    const H = V.selector || ''
    const U = 'ontouchstart' in K.documentElement
    let W = new Date().getTime()
    let B = []
    const Q = M
    const X = typeof Q === 'string'
    ...
    return (
      V.each(function (n) {
        ...
        const S = Y(p.context)
        let k = w.find(y.text)
        let T = w.find(y.search)
        let A = w.find(y.sizer)
        let R = w.find(y.input)
        let P = w.find(y.icon)
        let E = w.prev().find(y.text).length > 0 ? w.prev().find(y.text) : w.prev()
        let F = w.children(y.menu)
        let O = F.find(y.item)
        let D = !1
        let q = !1
        let j = !1
        ...
        (g = {
          ...
          select: {
            ...
            nextAvailable(e) {
              const t = (e = e.eq(0)).nextAll(y.item).not(y.unselectable).eq(0)
              const n = e.prevAll(y.item).not(y.unselectable).eq(0)
              t.length > 0
          ...
          setup: {
            ...
            select() {
              const e = g.get.selectValues()
              g.debug('Dropdown initialized on a select', e),
              w.is('select') && (R = w),
              R.parent(y.dropdown).length > 0
          ...
          hideSubMenus() {
            const e = F.children(y.item).find(y.menu)
          ...
          queryRemote(e, n) {
            let t = {
              ...
              onSuccess(e) {
                const t = e[l.remoteValues]
                Y.isArray(t) && t.length > 0
          ...
          filterItems(e) {
            const i = e !== J ? e : g.get.query()
            let o = null
            const t = g.escape.string(i)
            const a = new RegExp(`^${t}`, 'igm')
            g.has.query() &&
                  ((o = []),
                  ...
                  O.each(function () {
                    ...
                    let t
                    const n = Y(this)
                    if (p.match == 'both' || p.match == 'text') {
                      if ((e = String(g.get.choiceText(n, !1))).search(a) !== -1)
                        return o.push(this), !0
                      if (p.fullTextSearch === 'exact' && g.exactSearch(i, e))
                        return o.push(this), !0
                      if (!0 === p.fullTextSearch && g.fuzzySearch(i, e)) return o.push(this), !0
                    }
                    if (p.match == 'both' || p.match == 'value') {
                      if ((t = String(g.get.choiceValue(n, e))).search(a) !== -1)
                        return o.push(this), !0
                      if (p.fullTextSearch === 'exact' && g.exactSearch(i, t))
                        return o.push(this), !0
          ...
          fuzzySearch(e, t) {
            ...
            if (i === n) return e === t
            e: for (let o = 0, a = 0; o < i; o++) {
              for (let r = e.charCodeAt(o); a < n; ) if (t.charCodeAt(a++) === r) continue e
              return !1
            }
            return !0
          },
          ...
          forceSelection() {
            const e = O.not(h.filtered).filter(`.${h.selected}`).eq(0)
            const t = O.not(h.filtered).filter(`.${h.active}`).eq(0)
            const n = e.length > 0 ? e : t
            if (n.length > 0 && !g.is.multiple())
              return (
          ...
          event: {
            ...
            label: {
              click(e) {
                const t = Y(this)
                const n = w.find(y.label)
                const i = n.filter(`.${h.active}`)
                const o = t.nextAll(`.${h.active}`)
                const a = t.prevAll(`.${h.active}`)
                const r =
                      o.length > 0 ? t.nextUntil(o).add(i).add(t) : t.prevUntil(a).add(i).add(t)
                e.shiftKey
            ...
            menu: {
              mutation(e) {
                const t = e[0]
                const n = t.addedNodes ? Y(t.addedNodes[0]) : Y(!1)
                const i = t.removedNodes ? Y(t.removedNodes[0]) : Y(!1)
                const o = n.add(i)
                const a = o.is(y.addition) || o.closest(y.addition).length > 0
                const r = o.is(y.message) || o.closest(y.message).length > 0
                a || r
            ...
            item: {
              mouseenter(e) {
                const t = Y(e.target)
                const n = Y(this)
                const i = n.children(y.menu)
                const o = n.siblings(y.item).children(y.menu)
                const a = i.length > 0
                !(i.find(t).length > 0) &&
                      a &&
              ...
              mouseleave(e) {
                const t = Y(this).children(y.menu)
                t.length > 0 &&
                      (clearTimeout(g.itemTimer),
                      (g.itemTimer = setTimeout(() => {
              ...
              click(e, t) {
                const n = Y(this)
                const i = Y(e ? e.target : '')
                const o = n.find(y.menu)
                const a = g.get.choiceText(n)
                const r = g.get.choiceValue(n, a)
                const s = o.length > 0
                const l = o.find(i).length > 0
                ...
                l ||
                        ...
                        (g.is.searchSelection() &&
                          ...
                          g.remove.searchTerm(),
                          g.is.focusedOnSearch() || t == 1 || g.focusSearch(!0)),
            ...
            document: {
              keydown(e) {
                ...
                if (g.is.inObject(t, v)) {
                  const n = w.find(y.label)
                  let i = n.filter(`.${h.active}`)
                  const o = (i.data(b.value), n.index(i))
                  const a = n.length
                  const r = i.length > 0
                  const s = i.length > 1
                  const l = o === 0
                  const c = o + 1 == a
                  const u = g.is.searchSelection()
                  const d = g.is.focusedOnSearch()
                  const f = g.is.focused()
                  const m = d && g.get.caretPosition() === 0
                  if (u && !r && !d) return
                  t == v.leftArrow
                    ? (!f && !m) || r
                      ? r &&
            ...
            keydown(e) {
              ...
              if (g.is.inObject(t, v)) {
                let n
                const i = O.not(y.unselectable).filter(`.${h.selected}`).eq(0)
                const o = F.children(`.${h.active}`).eq(0)
                const a = i.length > 0 ? i : o
                const r =
                      a.length > 0
                        ? a.siblings(`:not(.${h.filtered})`).addBack()
                        : F.children(`:not(.${h.filtered})`)
                const s = a.children(y.menu)
                const l = a.closest(y.menu)
                const c =
                      l.hasClass(h.visible) ||
                      l.hasClass(h.animating) ||
                      l.parent(y.menu).length > 0
                const u = s.length > 0
                const d = a.length > 0
                const f = a.not(y.unselectable).length > 0
                const m = t == v.delimiter && p.allowAdditions && g.is.multiple()
                if (
                  (p.allowAdditions &&
                        p.hideAdditions &&
                        (t == v.enter || m) &&
                  ...
                  if (
                    ...
                    if (
                      ((n =
                            d && c ? a.prevAll(`${y.item}:not(${y.unselectable})`).eq(0) : O.eq(0)),
                      r.index(n) < 0)
                    )
                      return (
          ...
          trigger: {
            change() {
              const e = K.createEvent('HTMLEvents')
              const t = R[0]
              t &&
          ...
          determine: {
            ...
            eventInModule(e, t) {
              const n = Y(e.target)
              const i = n.closest(K.documentElement).length > 0
              const o = n.closest(w).length > 0
              return (
            ...
            eventOnElement(e, t) {
              const n = Y(e.target)
              const i = n.closest(y.siblingLabel)
              const o = K.body.contains(e.target)
              const a = w.find(i).length === 0
              const r = n.closest(F).length === 0
              return (
                (t = Y.isFunction(t) ? t : function () {}),
                o && a && r
                  ? (g.verbose('Triggering event', t), t(), !0)
          ...
          get: {
            ...
            placeholderText() {
              return p.placeholder != 'auto' && typeof p.placeholder === 'string'
                ? p.placeholder
            ...
            userValues() {
              let e = g.get.values()
              return (
                !!e && ((e = Y.isArray(e) ? e : [e]), Y.grep(e, e => !1 === g.get.item(e)))
              )
            },
            uniqueArray(n) {
              return Y.grep(n, (e, t) => Y.inArray(e, n) === t)
            },
            caretPosition() {
              let e
              let t
            ...
            value() {
              const e = R.length > 0 ? R.val() : w.data(b.value)
              const t = Y.isArray(e) && e.length === 1 && e[0] === ''
              return e === J || t ? '' : e
            },
            values() {
              const e = g.get.value()
            ...
            selectValues() {
              ...
              return (
                w.find('option').each(function () {
                  const e = Y(this)
                  const t = e.html()
                  const n = e.attr('disabled')
                  const i = e.attr('value') !== J ? e.attr('value') : t
                  p.placeholder === 'auto' && i === ''
                    ? (o.placeholder = t)
                ...
                p.sortSelect
                  ? (o.values.sort((e, t) => (e.name > t.name ? 1 : -1)),
            ...
            selectedItem() {
              const e = O.not(y.unselectable).filter(`.${h.selected}`)
              return e.length > 0 ? e : O.eq(0)
            },
            itemWithAdditions(e) {
              let t = g.get.item(e)
              const n = g.create.userChoice(e)
            ...
            item(i, o) {
              ...
              return (
                ...
                (e = a ? i.length > 0 : i !== J && i !== null),
                (a = g.is.multiple() && Y.isArray(i)),
                (o = i === '' || i === 0 || o || !1),
                e &&
                      O.each(function () {
                        const e = Y(this)
                        const t = g.get.choiceText(e)
                        const n = g.get.choiceValue(e, t)
                        if (n !== null && n !== J)
                          if (a)
                            (Y.inArray(String(n), i) === -1 && Y.inArray(t, i) === -1) ||
                              (r = r ? r.add(e) : e)
                          else if (o) {
                            if (
          ...
          scrollPage(e, t) {
            let n
            let i
            const o = t || g.get.selectedItem()
            const a = o.closest(y.menu)
            const r = a.outerHeight()
            const s = a.scrollTop()
            const l = O.eq(0).outerHeight()
            const c = Math.floor(r / l)
            const u = (a.prop('scrollHeight'), e == 'up' ? s - l * c : s + l * c)
            const d = O.not(y.unselectable);
            (i = e == 'up' ? d.index(o) - c : d.index(o) + c),
            (n = (e == 'up' ? i >= 0 : i < d.length)
              ? d.eq(i)
              : e == 'up'
                ? d.first()
                : d.last()).length > 0 &&
          ...
          set: {
            filtered() {
              const e = g.is.multiple()
              const t = g.is.searchSelection()
              const n = e && t
              const i = t ? g.get.query() : ''
              const o = typeof i === 'string' && i.length > 0
              const a = g.get.searchWidth()
              const r = i !== ''
              e &&
                    o &&
            ...
            activeItem(e) {
              p.allowAdditions && e.filter(y.addition).length > 0
                ? e.addClass(h.filtered)
                : e.addClass(h.active)
            },
            partialSearch(e) {
              const t = g.get.query().length
              T.val(e.substr(0, t))
            },
            scrollPosition(e, t) {
              let n
            ...
            selectedItem(e) {
              const t = g.get.choiceValue(e)
              const n = g.get.choiceText(e, !1)
              const i = g.get.choiceText(e, !0)
            ...
            selectedLetter(e) {
              let t
              const n = O.filter(`.${h.selected}`)
              const i = n.length > 0 && g.has.firstLetter(n, e)
              let o = !1
            ...
            direction(e) {
              p.direction == 'auto'
                ...
                : p.direction == 'upward' && g.set.upward(e)
            },
            upward(e) {
            ...
            value(e, t, n) {
              const i = g.escape.value(e)
              const o = R.length > 0
              const a = g.get.values()
              const r = e !== J ? String(e) : e
              if (o) {
                if (
                  !p.allowReselection &&
                      r == a &&
                ...
                g.verbose('Storing value in metadata', i, R), i !== a && w.data(b.value, r)
            ...
            selected(e, s) {
              ...
              (s = p.allowAdditions ? s || g.get.itemWithAdditions(e) : s || g.get.item(e)) &&
                    ...
                    s.each(function () {
                      ...
                      const t = g.get.choiceText(e)
                      const n = g.get.choiceValue(e, t)
                      const i = e.hasClass(h.filtered)
                      const o = e.hasClass(h.active)
                      const a = e.hasClass(h.addition)
                      const r = l && s.length == 1
                      l
                        ? !o || a
          ...
          add: {
            label(e, t, n) {
              let i
              const o = g.is.searchSelection() ? T : k
              let a = g.escape.value(e)
            ...
            message(e) {
              ...
              const n = p.templates.message(g.add.variables(e))
              t.length > 0
                ? t.html(n)
                : (t = Y('<div/>').html(n).addClass(h.message).appendTo(F))
            },
            optionValue(e) {
              const t = g.escape.value(e)
              R.find(`option[value="${g.escape.string(t)}"]`).length > 0 ||
                    (g.disconnect.selectObserver(),
                    g.is.single() &&
            ...
            userSuggestion(e) {
              let t
              let n = F.children(y.addition)
              const i = g.get.item(e)
              const o = i && i.not(y.addition).length
              const a = n.length > 0;
              (p.useLabels && g.has.maxSelections()) ||
                    (e === '' || o
                      ? n.remove()
            ...
            variables(e, t) {
              let n
              let i
              const o = e.search('{count}') !== -1
              const a = e.search('{maxCount}') !== -1
              const r = e.search('{term}') !== -1
              return (
          ...
          remove: {
            ...
            optionValue(e) {
              const t = g.escape.value(e)
              const n = R.find(`option[value="${g.escape.string(t)}"]`)
              n.length > 0 &&
            ...
            label(e, t) {
              const n = w.find(y.label).filter(`[data-${b.value}="${g.escape.string(e)}"]`)
            ...
            labels(e) {
              ...
              e.each(function () {
                const e = Y(this)
                const t = e.data(b.value)
                const n = t !== J ? String(t) : t
                const i = g.is.userValue(n)
          ...
          has: {
            menuSearch() {
              return g.has.search() && T.closest(F).length > 0
            },
            search() {
              return T.length > 0
            },
            ...
            message() {
              return F.children(y.message).length !== 0
            },
            label(e) {
              ...
              return (
                ...
                n.filter(`[data-${b.value}="${g.escape.string(t)}"]`).length > 0
              )
            },
            maxSelections() {
            ...
            allResultsFiltered() {
              const e = O.not(y.addition)
              return e.filter(y.unselectable).length === e.length
            },
            userSuggestion() {
              return F.children(y.addition).length > 0
            },
            query() {
              return g.get.query() !== ''
            },
            ...
            valueMatchingCase(e) {
              const t = g.get.values()
              return !!(Y.isArray(t) ? t && Y.inArray(e, t) !== -1 : t == e)
            },
            valueIgnoringCase(n) {
              let e = g.get.values()
              let i = !1
          ...
          is: {
            ...
            bubbledLabelClick(e) {
              return Y(e.target).is('select, input') && w.closest('label').length > 0
            },
            bubbledIconClick(e) {
              return Y(e.target).closest(P).length > 0
            },
            alreadySetup() {
              return (
                w.is('select') && w.parent(y.dropdown).data(C) !== J && w.prev().length === 0
              )
            },
            animating(e) {
              return e
            ...
            allFiltered() {
              return (
                (g.is.multiple() || g.has.search()) &&
                    !(p.hideAdditions == 0 && g.has.userSuggestion()) &&
                    !g.has.message() &&
                    g.has.allResultsFiltered()
              )
            },
            ...
            searchSelection() {
              return g.has.search() && T.parent(y.dropdown).length === 1
            },
            selection() {
              return w.hasClass(h.selection)
            },
            userValue(e) {
              return Y.inArray(e, g.get.userValues()) !== -1
            },
            upward(e) {
            ...
            verticallyScrollableContext() {
              const e = S.get(0) !== Z && S.css('overflow-y')
              return e == 'auto' || e == 'scroll'
            },
            horizontallyScrollableContext() {
              const e = S.get(0) !== Z && S.css('overflow-X')
              return e == 'auto' || e == 'scroll'
            },
          },
          can: {
  ...
  (Y.fn.dropdown.settings.templates = {
    ...
    menu(e, o) {
      ...
      return (
        Y.each(t, (e, t) => {
          const n = t[o.text] ? `data-text="${t[o.text]}"` : ''
          const i = t[o.disabled] ? 'disabled ' : '';
  ...
  (k.fn.embed = function (p) {
    ...
    return (
      v.each(function () {
        ...
        const u = `module-${n}`
        const d = (k(T), k(this))
        let f = (d.find(e.placeholder), d.find(e.icon), d.find(e.embed))
        const m = this
        let g = d.data(u);
        (s = {
          initialize() {
          ...
          determine: {
            ...
            source(n) {
              ...
              return (
                (n = n || s.get.url()) &&
                      k.each(o, (e, t) => {
                        if (n.search(t.domain) !== -1) return (i = e), !1
                      }),
                i
              )
            },
            ...
            url() {
              let e
              const t = i.id || d.data(a.id)
              const n = i.source || d.data(a.source)
          ...
          generate: {
            ...
            parameters(e, t) {
              let n = o[e] && o[e].parameters !== A ? o[e].parameters(i) : {}
              return (
        ...
        (l = {
          ...
          create: {
            dimmer() {
              ...
              const t = j.extend(!0, e, c.dimmerSettings)
              j.fn.dimmer !== M
          ...
          event: {
            ...
            click(e) {
              if (c.closable) {
                const t = j(e.target).closest(u.modal).length > 0
                const n = j.contains(I.documentElement, e.target)
                !t &&
                      n &&
                      l.is.active() &&
          ...
          hideAll(e) {
            const t = n.filter(`.${d.active}, .${d.animating}`);
            (e = j.isFunction(e) ? e : function () {}),
            t.length > 0 &&
          ...
          hideOthers(e) {
            const t = i.filter(`.${d.active}, .${d.animating}`);
            (e = j.isFunction(e) ? e : function () {}),
            t.length > 0 && (l.debug('Hiding other modals', i), t.modal('hide modal', e, !0))
          },
          others: {
            active() {
              return i.filter(`.${d.active}`).length > 0
            },
            animating() {
              return i.filter(`.${d.animating}`).length > 0
            },
          },
          add: {
            keyboardShortcuts() {
          ...
          save: {
            focus() {
              j(I.activeElement).closest(h).length > 0 || (e = j(I.activeElement).blur())
            },
          },
          restore: {
            focus() {
          ...
          cacheSizes() {
            ...
            const e = h.prop('scrollHeight')
            const t = h.outerWidth()
            const n = h.outerHeight();
            (l.cache !== M && n === 0) ||
                  ((l.cache = {
                    ...
                    contextHeight: c.context == 'body' ? j(z).height() : o.height(),
                  }),
          ...
          can: {
            useFlex() {
              return c.useFlex == 'auto' ? c.detachable && !l.is.ie() : c.useFlex
            },
            fit() {
              const e = l.cache.contextHeight
              const t = l.cache.contextHeight / 2
              const n = l.cache.topOffset
              const i = l.cache.scrollHeight
              const o = l.cache.height
              const a = c.padding
          ...
          set: {
            autofocus() {
              const e = h.find('[tabindex], :input').filter(':visible')
              const t = e.filter('[autofocus]')
              const n = t.length > 0 ? t.first() : e.first()
              n.length > 0 && n.focus()
            },
            clickaway() {
            ...
            modalOffset() {
              const e = l.cache.width
              const t = l.cache.height
...
(function (y, x, e, C) {
  ...
  (y.fn.nag = function (d) {
    ...
    return (
      e.each(function () {
        let s
        const i = y.isPlainObject(d)
          ? y.extend(!0, {}, y.fn.nag.settings, d)
          : y.extend({}, y.fn.nag.settings)
        const e = (i.className, i.selector)
        const l = i.error
        const t = i.namespace
        const n = `.${t}`
        const o = `${t}-module`
        const a = y(this)
        const r = (a.find(e.close), i.context ? y(i.context) : y('body'))
        const c = this
        const u = a.data(o)
        ...
        (s = {
          initialize() {
            ...
            i.displayTime > 0 && setTimeout(s.hide, i.displayTime),
            s.show()
          },
          destroy() {
          ...
          storage: {
            set(e, t) {
              const n = s.get.storageOptions()
              if (i.storageMethod == 'localstorage' && x.localStorage !== C)
                x.localStorage.setItem(e, t), s.debug('Value stored using local storage', e, t)
              else if (i.storageMethod == 'sessionstorage' && x.sessionStorage !== C)
            ...
            get(e, t) {
              let n
              return (
                i.storageMethod == 'localstorage' && x.localStorage !== C
                  ? (n = x.localStorage.getItem(e))
                  : i.storageMethod == 'sessionstorage' && x.sessionStorage !== C
                    ? (n = x.sessionStorage.getItem(e))
                    : y.cookie !== C
                      ? (n = y.cookie(e))
                      : s.error(l.noCookieStorage),
                (n != 'undefined' && n != 'null' && n !== C && n !== null) || (n = C),
                n
              )
            },
            remove(e) {
              const t = s.get.storageOptions()
              i.storageMethod == 'localstorage' && x.localStorage !== C
...
(function (z, I, M, L) {
  ...
  (z.fn.popup = function (k) {
    ...
    return (
      e.each(function () {
        ...
        const h = z(this)
        const s = z(f.context)
        const l = z(f.scrollContext)
        const v = z(f.boundary)
        const b = f.target ? z(f.target) : h
        let y = 0
        let x = !1
        let C = !1
        const w = this
        ...
        (d = {
          ...
          event: {
            start(e) {
              const t = z.isPlainObject(f.delay) ? f.delay.show : f.delay
              clearTimeout(d.hideTimer), C || (d.showTimer = setTimeout(d.show, t))
            },
            end() {
              const e = z.isPlainObject(f.delay) ? f.delay.hide : f.delay
            ...
            hideGracefully(e) {
              const t = z(e.target)
              const n = z.contains(M.documentElement, e.target)
              const i = t.closest(o.popup).length > 0
              e && !i && n
          ...
          exists() {
            return !!u && (f.inline || f.popup ? d.has.popup() : u.closest(s).length >= 1)
          },
          removePopup() {
            d.has.popup() &&
                  !f.popup &&
          ...
          get: {
            ...
            calculations() {
              let e
              const t = d.get.offsetParent(u)
              const n = b[0]
              const i = v[0] == I
              const o = f.inline || (f.popup && f.movePopup) ? b.position() : b.offset()
              const a = i ? { top: 0, left: 0 } : v.offset()
              let r = {}
              const s = i ? { top: R.scrollTop(), left: R.scrollLeft() } : { top: 0, left: 0 }
              if (
                ((r = {
                  target: {
                    element: b[0],
            ...
            startEvent() {
              return f.on == 'hover' ? 'mouseenter' : f.on == 'focus' && 'focus'
            },
            scrollEvent() {
              return 'scroll'
            },
            endEvent() {
              return f.on == 'hover' ? 'mouseleave' : f.on == 'focus' && 'blur'
            },
            ...
            offsetParent(e) {
              ...
              if (t)
                for (
                  let i = n.css('transform') === 'none',
                    o = n.css('position') === 'static',
                    a = n.is('body');
                  t && !a && o && i;

                )
                  (t = t.parentNode),
                  (i = (n = z(t)).css('transform') === 'none'),
                  (o = n.css('position') === 'static'),
                  (a = n.is('body'))
              return n && n.length > 0 ? n : z()
            },
            positions() {
              return {
                'top left': !1,
              ...
              if (b.length !== 0 && u.length !== 0) {
                ...
                if (
                  ...
                  d.should.centerArrow(t) &&
                        ...
                        (e != 'top left' && e != 'bottom left') ||
                          ((n += o.width / 2), (n -= f.arrowPixelsFromEdge)),
                        (e != 'top right' && e != 'bottom right') ||
                          ((n -= o.width / 2), (n += f.arrowPixelsFromEdge))),
                  o.width === 0 && o.height === 0 && !d.is.svg(o.element))
                )
          ...
          bind: {
            events() {
              ...
              f.on == 'click' && h.on(`click${a}`, d.toggle),
              f.on == 'hover' && h.on(`touchstart${a}`, d.event.touchstart),
              d.get.startEvent() &&
                      h
            ...
            close() {
              (!0 === f.hideOnScroll || (f.hideOnScroll == 'auto' && f.on != 'click')) &&
                    d.bind.closeOnScroll(),
              d.is.closable()
                ? d.bind.clickaway()
                : f.on == 'hover' && C && d.bind.touchClose()
            },
            closeOnScroll() {
          ...
          is: {
            closable() {
              return f.closable == 'auto' ? f.on != 'hover' : f.closable
            },
            offstage(e, n) {
              const i = []
              return (
  ...
  (z.fn.popup.settings = {
    ...
    templates: {
      ...
      popup(e) {
        let t = ''
        const n = z.fn.popup.settings.templates.escape
        return (
          typeof e !== L &&
                (typeof e.title !== L &&
                  e.title &&
  ...
  (k.fn.progress = function (h) {
    ...
    return (
      e.each(function () {
        ...
        const r = `module-${e}`
        const c = k(this)
        const u = k(this).find(o.bar)
        const d = k(this).find(o.progress)
        ...
        (s = {
          ...
          get: {
            text(e) {
              const t = s.value || 0
              const n = s.total || 0
              const i = p ? s.get.displayPercent() : s.percent || 0
              const o = s.total > 0 ? n - t : 100 - i
              return (
                (e = (e = e || '')
                  .replace('{value}', t)
                  .replace('{total}', n)
            ...
            normalizedValue(e) {
              ...
              } else if (e > 100) return s.debug('Value cannot increment above 100 percent'), 100
              return e
            },
            updateInterval() {
              return i.updateInterval == 'auto' ? i.duration : i.updateInterval
            },
            randomValue() {
              return (
            ...
            transitionEnd() {
              let e
              const t = T.createElement('element')
              const n = {
            ...
            displayPercent() {
              const e = u.width()
              const t = c.width()
              const n = parseInt(u.css('min-width'), 10) < e ? (e / t) * 100 : s.percent
              return i.precision > 0
          ...
          set: {
            ...
            duration(e) {
              (e = typeof (e = e || i.duration) === 'number' ? `${e}ms` : e),
            ...
            percent(e) {
              ...
              s.has.total() ||
                    ...
                    i.limitValues && (s.value = s.value > 100 ? 100 : s.value < 0 ? 0 : s.value)),
              s.set.barWidth(e),
              s.set.labelInterval(),
              s.set.labels(),
    ...
    return (
      p.each(function () {
        ...
        (i = {
          ...
          setup: {
            layout() {
              const e = i.get.maxRating()
              const t = w.fn.rating.settings.templates.icon(e)
          ...
          event: {
            ...
            click() {
              const e = w(this)
              const t = i.get.rating()
              const n = f.index(e) + 1;
              (o.clearable == 'auto' ? f.length === 1 : o.clearable) && t == n
                ? i.clearRating()
                : i.set.rating(n)
            },
          },
          ...
          get: {
            ...
            rating() {
              const e = f.filter(`.${a.active}`).length
  ...
  (E.fn.search = function (l) {
    ...
    return (
      E(this).each(function () {
        ...
        const t = `${e}-module`
        const h = E(this)
        let v = h.find(g.prompt)
        let n = h.find(g.searchButton)
        let o = h.find(g.results)
        let r = h.find(g.result)
        const b = (h.find(g.category), this)
        let s = h.data(t)
        let y = !1
        let x = !1;
        (f = {
          ...
          event: {
            ...
            blur(e) {
              ...
              t ||
                    ...
                    f.resultsClicked
                      ...
                      h.one(`click.close${i}`, g.results, e => {
                        f.is.inMessage(e) || y
                          ? v.focus()
            ...
            result: {
              ...
              click(e) {
                ...
                const t = E(this)
                const n = t.find(g.title).eq(0)
                const i = t.is('a[href]') ? t : t.find('a[href]').eq(0)
                const o = i.attr('href') || !1
                const a = i.attr('target') || !1
                const r = (n.html(), n.length > 0 && n.text())
                const s = f.get.results()
                const l = t.data(u.result) || f.get.result(r, s)
                ...
                o &&
                        ...
                        a == '_blank' || e.ctrlKey ? F.open(o) : (F.location.href = o))
              },
            },
          },
          handleKeyboard(e) {
            let t
            const n = h.find(g.result)
            const i = h.find(g.category)
            const o = n.filter(`.${m.active}`)
            const a = n.index(o)
            const r = n.length
            const s = o.length > 0
            const l = e.which
          ...
          is: {
            ...
            inMessage(e) {
              if (e.target) {
                const t = E(e.target)
                return (
                  E.contains(O.documentElement, e.target) && t.closest(g.message).length > 0
                )
              }
            },
            empty() {
            ...
            visible() {
              return o.filter(':visible').length > 0
            },
            focused() {
              return v.filter(':focus').length > 0
            },
          },
          get: {
            settings() {
          ...
          set: {
            ...
            type(e) {
              (e = e || c.type), c.type == 'category' && h.addClass(c.type)
            },
            buttonPressed() {
          ...
          search: {
            ...
            object(i, t, e) {
              ...
              const r = []
              const s = []
              const n = i.toString().replace(d.escape, '\\$&')
              const o = new RegExp(d.beginsWith + n, 'i')
              const l = function (e, t) {
                const n = E.inArray(t, a) == -1
                const i = E.inArray(t, s) == -1
                const o = E.inArray(t, r) == -1
                n && i && o && e.push(t)
              }
              return (
                (t = t || c.source),
                  ...
                  : (E.each(e, (e, n) => {
                    E.each(t, (e, t) => {
                      typeof t[n] === 'string' &&
                              (t[n].search(o) !== -1
                                ? l(a, t)
                                : c.fullTextSearch === 'exact' && f.exactSearch(i, t[n])
                                  ? l(r, t)
                                  : c.fullTextSearch == 1 && f.fuzzySearch(i, t[n]) && l(s, t))
                    })
                  }),
                  E.merge(r, s),
                  E.merge(a, r),
          ...
          has: {
            ...
            results() {
              return o.length !== 0 && o.html() != ''
            },
          },
          clear: {
            cache(e) {
              const t = h.data(u.cache)
              e
                ? e &&
                      t &&
                      t[e] &&
          ...
          create: {
            ...
            results() {
              o.length === 0 && (o = E('<div />').addClass(m.results).appendTo(h))
            },
          },
          inject: {
            result(e, t, n) {
          ...
          write: {
            cache(e, t) {
              const n = h.data(u.cache) !== D ? h.data(u.cache) : {}
              c.cache &&
          ...
          generateResults(e) {
            ...
            const n = E.isPlainObject(e[a.results]) && !E.isEmptyObject(e[a.results])
            const i = E.isArray(e[a.results]) && e[a.results].length > 0
            let o = ''
            return (
              n || i
                ? (c.maxResults > 0 &&
                        (n
                          ? c.type == 'standard' && f.error(p.maxResults)
      ...
      message(e, t) {
        ...
        return (
          e !== D &&
                ...
                (n +=
                  t == 'empty'
                    ? `<div class="header">No Results</div class="header"><div class="description">${e}</div class="description">`
      ...
      category(e, n) {
        ...
        return (
          e[n.categoryResults] !== D &&
              ...
              e[n.action] &&
                (i += `<a href="${e[n.action][n.actionURL]}" class="action">${
        ...
        (a = {
          ...
          set: {
            defaultSide() {
              ...
              (o = i.next(s.side).length > 0 ? i.next(s.side) : d.find(s.side).first()),
              (g = !1),
              a.verbose('Active side set to', i),
              a.verbose('Next side set to', o)
            },
            duration(e) {
              (e = typeof (e = e || r.duration) === 'number' ? `${e}ms` : e),
            ...
            currentStageSize() {
              const e = d.find(`.${r.className.active}`)
              const t = e.outerWidth(!0)
              const n = e.outerHeight(!0)
              d.css({ width: t, height: n })
            },
            stageSize() {
              const e = d.clone().addClass(l.loading)
              const t = e.find(`.${r.className.active}`)
              const n = g
                ? e.find(s.side).eq(g)
                : t.next(s.side).length > 0
                  ? t.next(s.side)
                  : e.find(s.side).first()
              const i =
                    r.width == 'next'
            ...
            nextSide(e) {
              ...
              (o = m.filter(e)),
              (g = m.index(o)),
              o.length === 0 && (a.set.defaultSide(), a.error(n.side)),
          ...
          get: {
            transform: {
              up() {
                return {
                  ...
                  }px) translateZ(${-i.outerHeight(!0) / 2}px) rotateX(-90deg)`,
                }
              },
              down() {
                return {
              ...
              left() {
                return {
                  ...
                  }px) translateZ(${-i.outerWidth(!0) / 2}px) rotateY(90deg)`,
                }
              },
              right() {
                return {
            ...
            transitionEvent() {
              let e
              const t = R.createElement('element')
              const n = {
                transition: 'transitionend',
                OTransition: 'oTransitionEnd',
                MozTransition: 'transitionend',
            ...
            nextSide() {
              return i.next(s.side).length > 0 ? i.next(s.side) : d.find(s.side).first()
            },
          },
          stage: {
            above() {
            ...
            left() {
              const e = i.outerWidth(!0)
              const t = o.outerWidth(!0)
              const n = { origin: (e - t) / 2, depth: { active: t / 2, next: e / 2 } }
  ...
  (q.fn.sidebar = function (x) {
    ...
    return (
      e.each(function () {
        ...
        const g = q(this)
        let p = q(u.context)
        let h = g.children(n.sidebar)
        let v = (p.children(n.fixed), p.children(n.pusher))
        const b = this
        let y = g.data(m);
        (c = {
          initialize() {
          ...
          event: {
            clickaway(e) {
              const t = v.find(e.target).length > 0 || v.is(e.target)
              const n = p.is(e.target)
              t && (c.verbose('User clicked on dimmed page'), c.hide()),
              n &&
                      (c.verbose('User clicked on dimmable context (scaled out page)'), c.hide())
            },
            touch(e) {},
            containScroll(e) {
            ...
            scroll(e) {
              q(e.target).closest(n.sidebar).length === 0 && e.preventDefault()
            },
          },
          bind: {
            clickaway() {
          ...
          add: {
            inlineCSS() {
              let e
              const t = c.cache.width || g.outerWidth()
              const n = c.cache.height || g.outerHeight()
              const i = c.is.rtl()
              const o = c.get.direction()
              const a = { left: t, right: -t, top: n, bottom: -n }
              i && (c.verbose('RTL detected, flipping widths'), (a.left = -t), (a.right = t)),
              (e = '<style>'),
              o === 'left' || o === 'right'
                ? (c.debug('Adding CSS rules for animation distance', t),
                (e += ` .ui.visible.${o}.sidebar ~ .fixed, .ui.visible.${o}.sidebar ~ .pusher {   -webkit-transform: translate3d(${a[o]}px, 0, 0);           transform: translate3d(${a[o]}px, 0, 0); }`))
                : (o !== 'top' && o != 'bottom') ||
                        (e += ` .ui.visible.${o}.sidebar ~ .fixed, .ui.visible.${o}.sidebar ~ .pusher {   -webkit-transform: translate3d(0, ${a[o]}px, 0);           transform: translate3d(0, ${a[o]}px, 0); }`),
              c.is.ie() &&
                      (o === 'left' || o === 'right'
                        ? (c.debug('Adding CSS rules for animation distance', t),
                        (e += ` body.pushable > .ui.visible.${o}.sidebar ~ .pusher:after {   -webkit-transform: translate3d(${a[o]}px, 0, 0);           transform: translate3d(${a[o]}px, 0, 0); }`))
                        : (o !== 'top' && o != 'bottom') ||
                          (e += ` body.pushable > .ui.visible.${o}.sidebar ~ .pusher:after {   -webkit-transform: translate3d(0, ${a[o]}px, 0);           transform: translate3d(0, ${a[o]}px, 0); }`),
                      (e +=
          ...
          setup: {
            cache() {
              c.cache = {
                ...
                rtl: g.css('direction') == 'rtl',
              }
            },
            layout() {
              p.children(n.pusher).length === 0 &&
                    (c.debug('Adding wrapper element for sidebar'),
                    c.error(d.pusher),
                    (v = q('<div class="pusher" />')),
                    p.children().not(n.omitted).not(h).wrapAll(v),
                    c.refresh()),
              (g.nextAll(n.pusher).length !== 0 && g.nextAll(n.pusher)[0] === v[0]) ||
            ...
            if (((e = q.isFunction(e) ? e : function () {}), c.is.hidden())) {
              if (
                ...
                if ((c.debug('Other sidebars currently visible'), u.exclusive)) {
                  if (u.transition != 'overlay') return void c.hideOthers(c.show)
                  c.hideOthers()
          ...
          othersAnimating() {
            return h.not(g).filter(`.${a.animating}`).length > 0
          },
          othersVisible() {
            return h.not(g).filter(`.${a.visible}`).length > 0
          },
          othersActive() {
            return c.othersVisible() || c.othersAnimating()
          },
          hideOthers(e) {
            const t = h.not(g).filter(`.${a.visible}`)
            const n = t.length
            let i = 0;
            (e = e || function () {}),
            t.sidebar('hide', () => {
          ...
          pushPage(t) {
            ...
            let n
            let i
            const o = c.get.transition()
            const a = o === 'overlay' || c.othersActive() ? g : v;
            (t = q.isFunction(t) ? t : function () {}),
            u.transition == 'scale down' && c.scrollToTop(),
            c.set.transition(o),
            c.repaint(),
            (e = function () {
          ...
          pullPage(t) {
            let e
            let n
            const i = c.get.transition()
            const o = i == 'overlay' || c.othersActive() ? g : v;
            (t = q.isFunction(t) ? t : function () {}),
            ...
            (n = function (e) {
              e.target == o[0] &&
                      ...
                      c.remove.transition(),
                      c.remove.inlineCSS(),
                      (i == 'scale down' || (u.returnScroll && c.is.mobile())) && c.scrollBack(),
                      t.call(b))
            }),
            o.off(l + s),
            o.on(l + s, n),
          ...
          get: {
            ...
            transition() {
              let e
              const t = c.get.direction()
              return (
                (e = c.is.mobile()
                  ? u.mobileTransition == 'auto'
            ...
            transitionEvent() {
              let e
              const t = z.createElement('element')
              const n = {
                transition: 'transitionend',
                OTransition: 'oTransitionEnd',
                MozTransition: 'transitionend',
          ...
          is: {
            ...
            ios() {
              ...
              const t = e.match(o.ios)
              const n = e.match(o.mobileChrome)
            ...
            rtl() {
              return (
                c.cache.rtl === I && (c.cache.rtl = g.css('direction') == 'rtl'), c.cache.rtl
              )
            },
          },
          setting(e, t) {
  ...
  (T.fn.sticky = function (v) {
    ...
    return (
      e.each(function () {
        ...
        const c = T(this)
        const u = T(A)
        const m = T(f.scrollContext)
        let g = (c.selector, c.data(l))
        const p =
        ...
        (d = {
          ...
          determineContext() {
            (o = f.context ? T(f.context) : i).length !== 0 ||
          ...
          save: {
            ...
            positions() {
              ...
              const n = { offset: o.offset(), height: o.outerHeight() }
              i.outerHeight()
              d.is.standardScroll() ||
          ...
          get: {
            ...
            elementScroll(e) {
              e = e || m.scrollTop()
              const t = d.cache.element
              const n = d.cache.scrollContext
              const i = d.get.scrollChange(e)
              const o = t.height - n.height + f.offset
              let a = d.get.currentElementScroll()
              const r = a + i
          ...
          set: {
            ...
            size() {
              d.cache.element.height !== 0 &&
                    d.cache.element.width !== 0 &&
          ...
          stick(e) {
            const t = e || m.scrollTop()
            const n = d.cache
            const i = n.fits
            const o = n.sameHeight
            const a = n.element
            const r = n.scrollContext
            const s = n.context
            const l = d.is.bottom() && f.pushing ? f.bottomOffset : f.offset
            const c =
...
(function (E, F, O, D) {
  ...
  (E.fn.tab = function (r) {
    let c
    const u = E.isFunction(this) ? E(F) : E(this)
    const d = u.selector || ''
    let f = new Date().getTime()
    let m = []
    const g = r
    const A = typeof g === 'string'
      ...
      u.each(function () {
        ...
        (b = {
          ...
          event: {
            ...
            history: {
              change(e) {
                const t = e.pathNames.join('/') || b.get.initialPath()
                const n = x.templates.determineTitle(t) || !1
          ...
          set: {
            auto() {
              const e =
                    typeof x.path === 'string' ? `${x.path.replace(/\/$/, '')}/{$tab}` : '/{$tab}'
          ...
          changeTab(d) {
            const f = F.history && F.history.pushState && x.ignoreFirstLoad && T
            const m = x.auto || E.isPlainObject(x.apiSettings)
            const g = m && !f ? b.utilities.pathToArray(d) : b.get.defaultPathArray(d);
            ...
            E.each(g, (e, t) => {
              ...
              let o
              let a
              const r = g.slice(0, e + 1)
              let s = b.utilities.arrayToPath(r)
              const l = b.is.tab(s)
              const c = e + 1 == g.length
              let u = b.get.tabElement(s)
          ...
          scrollTo(e) {
            const t = !!(e && e.length > 0) && e.offset().top
            !1 !== t &&
          ...
          update: {
            content(e, t, n) {
              const i = b.get.tabElement(e)
              const o = i[0];
              (n = n !== D ? n : x.evaluateScripts),
              typeof x.cacheType === 'string' &&
                    x.cacheType.toLowerCase() == 'dom' &&
                    typeof t !== 'string'
          ...
          fetch: {
            content(t, n) {
              ...
              const a = {
                ...
                headers: { 'X-Remote': !0 },
                onSuccess(e) {
                  x.cacheType == 'response' && b.cache.add(n, e),
              ...
              const r = o.api('get request') || !1
              const s = r && r.state() === 'pending';
              (n = n || t),
              (i = b.cache.read(n)),
              x.cache && i
                ? (b.activate.tab(t),
          ...
          activate: {
            ...
            tab(e) {
              const t = b.get.tabElement(e)
              const n = x.deactivate == 'siblings' ? t.siblings(a) : a.not(t)
              const i = t.hasClass(C.active)
            ...
            navigation(e) {
              const t = b.get.navElement(e)
              const n = x.deactivate == 'siblings' ? t.siblings(u) : u.not(t)
              const i = t.hasClass(C.active)
          ...
          is: {
            tab(e) {
              return e !== D && b.get.tabElement(e).length > 0
            },
          },
          get: {
            initialPath() {
            ...
            defaultPath(e) {
              const t = u.filter(`[data-${w.tab}^="${e}/"]`).eq(0).data(w.tab) || !1
              if (t) {
          ...
          utilities: {
            filterArray(e, t) {
              return E.grep(e, e => E.inArray(e, t) == -1)
            },
            last(e) {
              return !!E.isArray(e) && e[e.length - 1]
            },
            pathToArray(e) {
              return e === D && (e = h), typeof e === 'string' ? e.split('/') : [e]
            },
            arrayToPath(e) {
      ...
      r.each(function (i) {
        ...
        (f = {
          ...
          forceRepaint() {
            ...
            const e = m.parent()
            const t = m.next()
            t.length === 0 ? m.detach().appendTo(e) : m.detach().insertBefore(t)
          },
          repaint() {
          ...
          delay(e) {
            let t
            let n = f.get.animationDirection()
            n || (n = f.can.transition() ? f.get.direction() : 'static'),
            (e = e !== S ? e : u.interval),
            (t =
                    (u.reverse == 'auto' && n == d.outward) || u.reverse == 1
          ...
          force: {
            visible() {
              const e = m.attr('style')
              const t = f.get.userStyle()
              const n = f.get.displayType()
              const i = `${t}display: ${n} !important;`
              const o = m.css('display')
              const a = e === S || e === ''
              o !== n
          ...
          set: {
            ...
            duration(e, t) {
              ((t = typeof (t = t || u.duration) === 'number' ? `${t}ms` : t) || t === 0) &&
          ...
          save: {
            ...
            displayType(e) {
              e !== 'none' && m.data(n.displayType, e)
            },
            transitionExists(e, t) {
          ...
          restore: {
            conditions() {
              const e = f.get.currentAnimation()
          ...
          get: {
            ...
            animationClass(e) {
              const t = e || u.animation
              const n = f.can.transition() && !f.has.direction() ? `${f.get.direction()} ` : ''
          ...
          can: {
            transition(e) {
              ...
              let r
              const s = u.animation
              const l = f.get.transitionExists(s)
              let c = f.get.displayType(!1)
              if (l === S || e) {
                if (
                  (f.verbose('Determining whether animation exists'),
                  (t = m.attr('class')),
                  (n = m.prop('tagName')),
                  (o = (i = C(`<${n} />`).addClass(t).insertAfter(m))
                    .addClass(s)
                  ...
                  if (o == 'none' || !o) return void f.debug('No animation defined in css', s)
          ...
          is: {
            ...
            occurring(e) {
              return (
                (e = `.${(e = e || u.animation).replace(' ', '.')}`), m.filter(e).length > 0
              )
            },
            visible() {
              return m.is(':visible')
            ...
            hidden() {
              return m.css('visibility') === 'hidden'
            },
            supported() {
              return !1 !== o
            },
...
(function (P, E, e, F) {
  ...
  (P.api = P.fn.api =
      function (x) {
        let C
        const e = P.isFunction(this) ? P(E) : P(this)
        const w = e.selector || ''
        ...
        return (
          e.each(function () {
            ...
            const m = `module-${t}`
            const g = P(this)
            const p = g.closest(o.form)
            const h = c.stateContext ? P(c.stateContext) : g
            const v = this
            const b = h[0]
            let y = g.data(m);
            (l = {
              ...
              bind: {
                events() {
                  ...
                  e
                    ...
                    : c.on == 'now' && (l.debug('Querying API endpoint immediately'), l.query())
                },
              },
              decode: {
                json(e) {
                  if (e !== F && typeof e === 'string')
                    try {
                      e = JSON.parse(e)
                    } catch (e) {}
                  return e
                  ...
                  if (((l.cancelled = !1), (n = l.get.templatedURL()) || l.is.mocked())) {
                    if ((n = l.add.urlData(n)) || l.is.mocked()) {
                      if (
                        ...
                        c.cache === 'local' && l.read.cachedResponse(n))
                      )
                        return (
              ...
              should: {
                removeError() {
                  return !0 === c.hideError || (c.hideError === 'auto' && !l.is.form())
                },
              },
              is: {
                disabled() {
                  return g.filter(o.disabled).length > 0
                },
                expectingJSON() {
                  return c.dataType === 'json' || c.dataType === 'jsonp'
                },
                form() {
                ...
                loading() {
                  return !!l.request && l.request.state() == 'pending'
                },
                abortedRequest(e) {
                  return e && e.readyState !== F && e.readyState === 0
                ...
                validResponse(e) {
                  return l.is.expectingJSON() && P.isFunction(c.successTest)
                    ...
                    : (l.verbose('Response is not JSON, skipping validation', c.successTest, e),
                    !0)
                },
              },
              was: {
                ...
                succesful() {
                  return l.request && l.request.state() == 'resolved'
                },
                failure() {
                  return l.request && l.request.state() == 'rejected'
                },
                complete() {
                  return (
                    l.request &&
                    (l.request.state() == 'resolved' || l.request.state() == 'rejected')
                  )
                },
              },
              add: {
                ...
                formData(e) {
                  const t = P.fn.serializeObject !== F
                  const n = t ? p.serializeObject() : p.serialize()
                  return (
                    (e = e || c.data),
                    (e = P.isPlainObject(e)
                      ? t
              ...
              event: {
                trigger(e) {
                  l.query(), (e.type != 'submit' && e.type != 'click') || e.preventDefault()
                },
                xhr: {
                  always() {},
                  done(e, t, n) {
                    ...
                    r &&
                        ...
                        (e = r)),
                    a > 0 && l.debug('Response completed early delaying state change by', a),
                    setTimeout(() => {
                ...
                request: {
                  ...
                  fail(e, t, n) {
                    const i = l.get.responseFromXHR(e)
                    const o = l.get.errorFromRequest(i, t, n)
                    if (t == 'aborted')
                      return (
                        l.debug(
              ...
              create: {
                ...
                mockedXHR() {
                  ...
                  let t
                  let n
                  const i = c.mockResponse || c.response
                  const o = c.mockResponseAsync || c.responseAsync
                  return (
                    (n = P.Deferred()
              ...
              get: {
                ...
                urlEncodedValue(e) {
                  const t = E.decodeURIComponent(e)
              ...
              abort() {
                const e = l.get.xhr()
                e && e.state() !== 'resolved' && (l.debug('Cancelling API request'), e.abort())
              },
              reset() {
        ...
        (s = {
          initialize() {
            ...
            s.should.trackChanges() &&
                    (o.type == 'image' && s.setup.image(),
                    o.type == 'fixed' && s.setup.fixed(),
          ...
          destroy() {
            ...
            o.type == 'fixed' && (s.resetFixed(), s.remove.placeholder()),
            ...
            visible() {
              return (
                !(!s.cache || !s.cache.element) &&
                    !(s.cache.element.width === 0 && s.cache.element.offset.top === 0)
              )
            },
            verticallyScrollableContext() {
              const e = m.get(0) !== E && m.css('overflow-y')
              return e == 'auto' || e == 'scroll'
            },
            horizontallyScrollableContext() {
              const e = m.get(0) !== E && m.css('overflow-x')
              return e == 'auto' || e == 'scroll'
            },
          },
          refresh() {
            s.debug('Refreshing constants (width/height)'),
            o.type == 'fixed' && s.resetFixed(),
            s.reset(),
            s.save.position(),
          ...
          onScreen(e) {
            const t = s.get.elementCalculations()
            const n = e || o.onOnScreen
            const i = 'onScreen'
            if (
          ...
          bottomVisible(e) {
            const t = s.get.elementCalculations()
            const n = e || o.onBottomVisible
            const i = 'bottomVisible'
            if (
          ...
          bottomPassed(e) {
            const t = s.get.elementCalculations()
            const n = e || o.onBottomPassed
            const i = 'bottomPassed'
            if (
          ...
          passingReverse(e) {
            const t = s.get.elementCalculations()
            const n = e || o.onPassingReverse
            const i = 'passingReverse'
            if (
              (e &&
          ...
          topVisibleReverse(e) {
            const t = s.get.elementCalculations()
            const n = e || o.onTopVisibleReverse
            const i = 'topVisibleReverse'
            if (
              (e &&
          ...
          bottomVisibleReverse(e) {
            const t = s.get.elementCalculations()
            const n = e || o.onBottomVisibleReverse
            const i = 'bottomVisibleReverse'
            if (
              (e &&
          ...
          topPassedReverse(e) {
            const t = s.get.elementCalculations()
            const n = e || o.onTopPassedReverse
            const i = 'topPassedReverse'
            if (
              (e &&
          ...
          bottomPassedReverse(e) {
            const t = s.get.elementCalculations()
            const n = e || o.onBottomPassedReverse
            const i = 'bottomPassedReverse'
            if (
              (e &&
          ...
          execute(e, t) {
            const n = s.get.elementCalculations()
            const i = s.get.screenCalculations();
            (e = e || !1) &&
                  (o.continuous
          ...
          save: {
            ...
            direction() {
              let e
              const t = s.get.scroll()
              const n = s.get.lastScroll()
              return (
            ...
            elementPosition() {
              const e = s.cache.element
              const t = s.get.screenSize()
              return (
            ...
            elementCalculations() {
              const e = s.get.screenCalculations()
              const t = s.get.elementPosition()
              return (
                o.includeMargin
                  ? ((t.margin = {}),
